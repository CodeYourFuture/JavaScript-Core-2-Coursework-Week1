/*
VERSION 2 - An alternative solution to this task
*/
...
function countWords(string) {
  ...
  */
        ...
        if (theWord.length !== 0) // this word is definitely nonnull
                if (!wordCount.hasOwnProperty(theWord)) // First occurrence of this 'word', so a count of 1
                            wordCount[theWord] = 1
                else
                            ++wordCount[theWord];       // Increment the count by one
                                });
