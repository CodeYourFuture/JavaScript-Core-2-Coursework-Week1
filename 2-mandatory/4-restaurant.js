/*
  You are at a restaurant that has two items on the menu,
  burger and falafel.
  The menu object includes these two items and their price.

  You have an object cashRegister which handles charging 
  for ordered items but it is missing some methods to do this.
