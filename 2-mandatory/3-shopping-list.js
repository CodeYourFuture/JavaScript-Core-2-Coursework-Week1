...
function createShoppingList(recipe) {
          // if the ingredient is neither in pantry.fridgeContents NOR in pantry.cupboardContents then it is a missing ingredient
          // filter ALL the ingredients that match that criteria:
          
          return {name: recipe["name"],
                  items: recipe["ingredients"]
                         .filter(anIngredient => !(pantry.fridgeContents.includes(anIngredient) || pantry.cupboardContents.includes(anIngredient)))}
}
