...
function createShoppingList(recipe) {
  ...
  {
    if ((pantry.cupboardContents.includes(recipe.ingredients[element])) || (pantry.fridgeContents.includes(recipe.ingredients[element])))
    {}
    else
    {
      itemList.push(recipe.ingredients[element]);
    }
  }
