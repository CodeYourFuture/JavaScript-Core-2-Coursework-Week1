...
function createShoppingList(recipe) {
  ...
  //to take every element of list of ingredients and to check first  if we have it in the fridge and if we have it in the cupboard.
  //if not - then add to the shopping list.
