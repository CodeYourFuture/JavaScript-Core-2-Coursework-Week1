...
function createShoppingList(recipe) {
  ...
  let myIngredients = [...pantry.fridgeContents, ...pantry.cupboardContents];
  let missingIngredients = recipe.ingredients.filter(ingredient => !myIngredients.includes(ingredient))
  let objectToReturn = {
    name: recipe.name,
