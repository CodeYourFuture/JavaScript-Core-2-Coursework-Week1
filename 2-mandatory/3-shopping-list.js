...
function createShoppingList(recipe) {
 listOfShopping = recipe.ingredients.filter((ingredient)=> {
  return(
    !pantry.fridgeContents.includes(ingredient) && !pantry.cupboardContents.includes(ingredient)
  )
 });
 return {
  name : recipe.name,
  items : listOfShopping,
 }
