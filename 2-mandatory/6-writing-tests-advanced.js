...
/*
  Write a test that checks the output of formatCourseworkResult when passed 
  the following trainee:
  */
test("should return grade C for trainee Xin", () => {
  let trainee = {
    name: "Xin",
    score: 63,
  };
...
test("should return grade B for trainee Mona", () => {
  let trainee = {
    name: "Mona",
    score: 78,
  };
...
test("should return grade E for trainee Ali", () => {
  trainee = {
    name: "Ali",
    score: 49,
    age: 33,
