...
*/
test("Should return Xin's coursework was marked as grade C", () => {
  let trainee = {
    name: "Xin",
    score: 63,
  };
...
*/
test("Should return Mona's coursework was marked as grade B", () => {
  let trainee = {
    name: "Mona",
    score: 78,
  };
...
*/
test("Should return Ali's coursework was marked as grade E", () => {
  let trainee = {
    name: "Ali",
    score: 49,
    age: 33,
...
*/
test("Should return error when there is no trainee name", () => {
  let trainee = {
    score: 78,
    age: 29,
  };
...
*/
test("Should return error when coursework score not provided", () => {
  let trainee = {
    name: "Aman",
    subjects: ["HTML", "CSS", "Databases"],
  };
