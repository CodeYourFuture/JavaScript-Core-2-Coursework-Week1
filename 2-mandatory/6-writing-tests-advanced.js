...
*/
test("should return: Ali's courswork was marked as grade E.", () => {
  const trainee = {
    name: "Ali",
    score: 49,
    age: 33,
...
*/
test("should return: Error: no trainee name!", () => {
  const trainee = {
    score: 90,
    age: 29,
  };
...
test("should return: Error: Coursework percent is not a number!", () => {
  const trainee = {
    name: "Aman",
    subjects: ["HTML", "CSS", "Databases"],
  };
