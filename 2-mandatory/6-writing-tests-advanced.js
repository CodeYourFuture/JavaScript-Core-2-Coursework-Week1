...
test("formatCourseworkResult trainee's coursework", () => {
  const traineeObject = {
    name: "Xin",
    score: 63,
  };

  expect(formatCourseworkResult(traineeObject)).toBe(
...
test("formatCourseworkResult trainee's coursework", () => {
  ...
  expect(formatCourseworkResult(traineeObject)).toBe("Error: No trainee name!");
});
