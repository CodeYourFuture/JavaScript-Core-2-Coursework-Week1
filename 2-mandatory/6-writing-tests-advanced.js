...
*/
test("checks the output of formatCourseworkResult with score 63", () => {
  let trainee = {
    name: "Xin",
    score: 63,
  };
...
*/
test("checks the output of formatCourseworkResult with score 78", () => {
  let trainee = {
    name: "Mona",
    score: 78,
  };
...
*/
test("checks the output of formatCourseworkResult with numbers", () => {
  let trainee = {
    name: "Ali",
    score: 49,
    age: 33,
...
*/
test("checks the output of formatCourseworkResult with string", () => {
  let trainee = {
    score: 90,
    age: 29,
  };
...
*/
test("checks the output of formatCourseworkResult with number", () => {
  let trainee = {
    name: "Aman",
    subjects: ["HTML", "CSS", "Databases"],
  };
