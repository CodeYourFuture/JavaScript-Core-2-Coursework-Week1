...
*/
test("returns correct coursework result for trainee with score of 63", () => {
...
*/
test("returns correct coursework result for trainee with score of 78", () => {
...
*/
test("returns correct coursework result for trainee with score of 49 and additional properties", () => {
...
*/
test("returns error for trainee with no name", () => {
...
*/
test("returns correct coursework result for trainee with no score", () => {
